  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col pt-16 pb-24 px-6 overflow-hidden relative">
      ...
      <div className="flex flex-col items-center text-center space-y-6 mb-16 relative z-10">
        ...
        >
          Welcome to <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-[#a64a85] to-primary bg-[length:200%_auto] animate-gradient block mt-2">Fudron Food Delivery</span>
        </motion.h1>
      ...
      <div className="mt-16 flex flex-col items-center gap-3 opacity-50">
        <div className="flex items-center gap-1.5 grayscale">
          ...
          <span className="text-[10px] font-black uppercase tracking-widest">Secure by Fudron Food Delivery</span>
        </div>
      </div>
    </div>
  )
