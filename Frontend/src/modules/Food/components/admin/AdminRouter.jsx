...
const RestaurantSubscriptions = lazy(() => import("@food/pages/admin/restaurant/RestaurantSubscriptions"));
// Food Management
...
const LoyaltyPointSettings = lazy(() => import("@food/pages/admin/loyalty-point/Settings"));
      ...
      <Routes>
        ...
        >
          ...
          <Route path="food/*">
            ...
            <Route path="restaurants/subscriptions" element={<RestaurantSubscriptions />} />

            {/* FOOD & CATEGORY MANAGEMENT */}
            <Route path="categories" element={<Category />} />
            <Route path="fee-settings" element={<FeeSettings />} />
            <Route path="referral-settings" element={<ReferralSettings />} />
            <Route path="loyalty-settings" element={<LoyaltyPointSettings />} />
